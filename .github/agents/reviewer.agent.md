...
target: vscode
tools: ['read', 'search', 'execute/runInTerminal', 'vscode/askQuestions', 'knowledge/*', 'salesforce/review_installed_packages', 'salesforce/review_object_contract', 'salesforce/review_soql_query']
hooks:
  PreToolUse:
    - type: command
